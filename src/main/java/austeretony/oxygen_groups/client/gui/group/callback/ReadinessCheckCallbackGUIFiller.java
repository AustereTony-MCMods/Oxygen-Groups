...
public class ReadinessCheckCallbackGUIFiller extends BackgroundGUIFiller {

    public ReadinessCheckCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, GroupMenuGUIScreen.READINESS_CHECK_CALLBACK_BACKGROUND);
    }
