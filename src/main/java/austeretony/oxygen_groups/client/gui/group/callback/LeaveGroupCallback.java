...
public class LeaveGroupCallback extends AbstractGUICallback {
    ...
    public LeaveGroupCallback(GroupMenuScreen screen, GroupSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_groups.gui.callback.leaveGroup"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_groups.gui.callback.leaveGroup.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    private void confirm() {
        GroupsManagerClient.instance().getGroupDataManager().leaveGroupSynced();
        this.screen.close();
    }
