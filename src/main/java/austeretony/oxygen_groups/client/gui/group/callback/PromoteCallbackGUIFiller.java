...
public class PromoteCallbackGUIFiller extends BackgroundGUIFiller {

    public PromoteCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, GroupMenuGUIScreen.PROMOTE_CALLBACK_BACKGROUND);
    }
