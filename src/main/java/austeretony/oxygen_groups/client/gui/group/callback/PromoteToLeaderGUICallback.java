...
public class PromoteToLeaderGUICallback extends AbstractGUICallback {
    ...
    public PromoteToLeaderGUICallback(GroupMenuGUIScreen screen, GroupGUISection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("groups.gui.promoteToLeaderCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestTextBoxLabel.setDisplayText(I18n.format("groups.gui.promoteToLeaderCallback.request", this.section.getCurrentEntry().getDisplayText()), false, GUISettings.instance().getTextScale());
    }
