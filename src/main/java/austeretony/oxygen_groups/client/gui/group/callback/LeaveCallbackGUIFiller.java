...
public class LeaveCallbackGUIFiller extends BackgroundGUIFiller {

    public LeaveCallbackGUIFiller(int xPosition, int yPosition, int width, int height) {             
        super(xPosition, yPosition, width, height, GroupMenuGUIScreen.LEAVE_CALLBACK_BACKGROUND);
    }
