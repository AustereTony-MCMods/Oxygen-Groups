...
public class PromoteToLeaderCallback extends AbstractGUICallback {
    ...
    public PromoteToLeaderCallback(GroupMenuScreen screen, GroupSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_groups.gui.callback.promoteToLeader"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_groups.gui.callback.promoteToLeader.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    private void confirm() {
        GroupsManagerClient.instance().getGroupDataManager().promoteToLeaderSynced(this.section.getCurrentEntry().index);
        this.screen.close();
    }
