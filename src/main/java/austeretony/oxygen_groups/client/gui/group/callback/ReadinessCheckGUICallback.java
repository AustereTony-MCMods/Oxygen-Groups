...
public class ReadinessCheckGUICallback extends AbstractGUICallback {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("groups.gui.readinessCheckCallback"), true, GUISettings.instance().getTitleScale()));
        this.addElement(new GUITextLabel(2, 16).setDisplayText(I18n.format("groups.gui.readinessCheckCallback.request"), false, GUISettings.instance().getTextScale()));        
