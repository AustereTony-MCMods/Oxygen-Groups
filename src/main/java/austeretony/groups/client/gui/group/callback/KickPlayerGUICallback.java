...
public class KickPlayerGUICallback extends AbstractGUICallback {
    ...
    public KickPlayerGUICallback(GroupMenuGUIScreen screen, GroupGUISection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("groups.gui.kickPlayerCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestTextBoxLabel.setDisplayText(I18n.format("groups.gui.kickPlayerCallback.request", this.section.getCurrentEntry().getDisplayText()), false, GUISettings.instance().getTextScale());
    }
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (element == this.cancelButton)
            ...
            GroupsManagerClient.instance().startKickPlayerVotingSynced(this.section.getCurrentEntry().playerUUID);
            this.close();            
        }
    }
}
