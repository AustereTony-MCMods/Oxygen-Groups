...
import austeretony.groups.client.gui.group.callback.DownloadDataGUICallback;
import austeretony.groups.client.gui.group.callback.InvitePlayerGUICallback;
import austeretony.groups.client.gui.group.callback.KickPlayerGUICallback;
import austeretony.groups.client.gui.group.callback.LeaveGroupGUICallback;
import austeretony.groups.client.gui.group.callback.PromoteToLeaderGUICallback;
import austeretony.groups.client.gui.group.callback.ReadinessCheckGUICallback;
import austeretony.groups.client.gui.group.context.KickPlayerContextAction;
import austeretony.groups.client.gui.group.context.PromoteToLeaderContextAction;
...
public class GroupGUISection extends AbstractGUISection {
    ...
    public void init() {
        ...
        GUIScroller scroller = new GUIScroller(GroupsConfig.PLAYERS_PER_PARTY.getIntValue(), 14);
        ...
        this.addElement(this.inviteButton = new GUIButton(4, this.getHeight() - 11,  40, 10).setSound(OxygenSoundEffects.BUTTON_CLICK)
        ...
        this.addElement(this.leaveButton = new GUIButton(54, this.getHeight() - 11,  40, 10).setSound(OxygenSoundEffects.BUTTON_CLICK)
                .enableDynamicBackground(GUISettings.instance().getEnabledButtonColor(), GUISettings.instance().getDisabledButtonColor(), GUISettings.instance().getHoveredButtonColor())
        ...
        this.addElement(this.checkButton = new GUIButton(104, this.getHeight() - 11,  40, 10).setSound(OxygenSoundEffects.BUTTON_CLICK)
                .enableDynamicBackground(GUISettings.instance().getEnabledButtonColor(), GUISettings.instance().getDisabledButtonColor(), GUISettings.instance().getHoveredButtonColor())
